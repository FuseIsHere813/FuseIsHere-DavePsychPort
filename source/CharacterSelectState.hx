...
/**
    hey yall fun fnf mod dev people, This is FuseIsHere speaking, i don't know about the rest of the mod port but since this is basically like 90% my code 
 i do not give you guys permission to grab this specific code and re-use it in your own mods without asking me first, which is the main dev, Fuse.
*/
...
class CharacterSelectState extends MusicBeatState
{
    ...
    var text:FlxText = new FlxText(0, 0, FlxG.width, "Character Selection Menu", 20);
    ...
    override public function create():Void
        {
            var bg:FlxSprite = new FlxSprite(0, -50).loadGraphic(Paths.image('dahouse'));

            text.font = 'Comic Sans MS Bold';
            text.setFormat(Paths.font("comic.ttf"),30,FlxColor.BLACK,FlxTextAlign.CENTER);
            ...
            FlxG.sound.playMusic(Paths.music("characterMenu"),1,true);
            add(end);
            // logoBl.screenCenter();
